    ...
    <div className='Main__container'>
      ...
      <div className='Main__hello_container'>
        ...
        <div className='Main__hello_info_container'>
          ...
          <div className='Main__hello_info_btn_container'>
            <a href="/CV_Makhovsky_Maxim_Frontend.pdf" download>Download CV</a>
          </div>
        </div>
      ...
      <div className='Main__works_container'>
        ...
        <div className='Main__works_works'>
          {works.map(work => {
            return (
              <WorkBox key={`Work-${work.id}`} id={work.id} name={work.name} description={work.description} image={work.image} url={work.url}/>
            )
          })}
        </div>
      </div>
      ...
      <div className='Main__expertise_container'>
        <div className='Main__expertise_expertise'>
          ...
          <span>Expertise</span>
          <span>More than 1 year of hands-on experience and hundreds of millions in spend have yielded a diverse skillset that touches on most every function. This is a partial list.</span>
          <div className='Main__experstise_btn_container'>
            <a href="/CV_Makhovsky_Maxim_Frontend.pdf" download>RESUME</a>
          </div>
        </div>
